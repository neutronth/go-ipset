...
const testHashIPIPSetLockfilePath = "ipset.lock"

func TestHashIPIPSetSpec(t *testing.T) {
	cases := []struct {
		name          string
		set           *IPSet
		expectedError error
...
func TestHashIPCreateSet(t *testing.T) {
	cases := []struct {
		name              string
		set               *IPSet
	...
	for _, c := range cases {
		...
		runner := newInternal(&fexec, testHashIPIPSetLockfilePath)
...
func TestHashIPDestroySet(t *testing.T) {
	cases := []struct {
		name              string
		setname           string
		combinedOutputLog [][]string
...
func TestHashIPListSets(t *testing.T) {
	cases := []struct {
		name     string
		output   []byte
		expected []string
...
func TestHashIPListEntries(t *testing.T) {
	cases := []struct {
		name     string
		setname  string
		output   []byte
...
func TestHashIPAddEntry(t *testing.T) {
	cases := []struct {
		name              string
		setname           string
		entry             IPSetEntry
...
func TestHashIPDelEntry(t *testing.T) {
	cases := []struct {
		name              string
		setname           string
		entryElement      string
